...
class DoctorOrderScreen extends StatefulWidget {
  @override
  _DoctorOrderScreenState createState() => _DoctorOrderScreenState();
}

class _DoctorOrderScreenState extends State<DoctorOrderScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: allOrdersApi.getAllDoctorOrders(),
    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => ItemDetails(map)),
          );
        },
        child: Container(
          height: 100,
